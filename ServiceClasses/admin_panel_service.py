...
Покупки: сегодня - {today_shop if today_shop else 'сегодня нет покупок '} / {today_shop_money} ₽  за 7 дн — {one_week_shop if one_week_shop  else 'за неделю не было покупок'} / {one_week_shop_money} ₽ за 30 дн — {one_month_shop if one_month_shop  else 'не было покуапок за месяц'} / {one_month_shop_money} ₽'''
        return text
